...
export default function ProjectCard({ project }: { project: Project }) {
	return (
		<div className='bg-surface border border-border rounded-lg p-6 flex flex-col gap-3 transition-all duration-300 hover:border-primary/40 hover:shadow-[0_0_25px_rgba(91,63,140,0.25)]'>
